...
import (
	...
	"github.com/clinton-mwachia/go-sqlite-mastery/31-cross-join/models"
...
// Every country combined with every city → countries × cities
// Cross Join returns every combination of country and city (Cartesian product)
func GetCountryCityCombinations(db *sql.DB) ([]models.City, error) {
	query := `
