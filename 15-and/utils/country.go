...
import (
	...
	"github.com/clinton-mwachia/go-sqlite-mastery/15-and/models"
...
func FindByPopulationAndArea(db *sql.DB, minPopulation int, maxArea float64) ([]models.Country, error) {
