...
import (
	...
	"github.com/clinton-mwachia/go-sqlite-mastery/15-and/utils"
...
func main() {
	...
	// find countries with population and area
	countries, err = utils.FindByPopulationAndArea(db, 1000000000, 500000000)
	if err != nil {
		fmt.Println(err)
		return
	}
