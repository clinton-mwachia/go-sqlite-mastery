...
import (
	...
	"github.com/clinton-mwachia/go-sqlite-mastery/21-distinct/models"
...
func SelectUniqueCountry(db *sql.DB) ([]models.Country, error) {
	query := `SELECT Distinct name FROM countries ORDER BY name`
